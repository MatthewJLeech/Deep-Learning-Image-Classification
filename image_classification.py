...
Original file is located at
    https://colab.research.google.com/drive/1Gdm2FxAhbm3nH6rsg7ERtM71SlLUHjX4
"""
...
date = ImageDataBunch.from_folder(
    path,
    train="train",
    test="test",
...
date.normalize(imagenet_stats)

# create a CNN learner named "learner" with resnet34
learner = cnn_learner(date,models.resnet34, metrics=[accuracy])
...
# fine tune the model and check the result again by changing valid_pct to .5
path = "/content/plant-seedlings-classification"
size = 244
bs = 64
...
#re-running the model to see accuracy
lr = learner.recorder.min_grad_lr
learner.fit_one_cycle(1, lr)